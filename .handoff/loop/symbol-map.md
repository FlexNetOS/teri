...
- [ ] S-167 · `unit:U-013` · `type` · `TextProcessor` · static class · `text_processor.py:9`
- [ ] S-168 · `unit:U-013` · `method` · `TextProcessor.extract_from_files` · delegates to FileParser · `text_processor.py:13`
- [ ] S-169 · `unit:U-013` · `method` · `TextProcessor.split_text` · char-count split with overlap · `text_processor.py:18`
- [ ] S-170 · `unit:U-013` · `method` · `TextProcessor.preprocess_text` · normalises whitespace · `text_processor.py:37`
- [ ] S-171 · `unit:U-013` · `method` · `TextProcessor.get_text_stats` · returns dict with char/word/line counts · `text_processor.py:64`
